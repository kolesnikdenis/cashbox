...
if ( $taskk == "show_cashbox" ) {
        ...
        if($eierr=="no"){
                ...
                while ($pl=mysql_fetch_array($res)){
                  ...
                  if ( strCaseCmp($pl[2], "minimarcet" ) ==0 )  { $ost_minik =$ost_minik+($pl[3] * $count_left );  $add_minik = $add_minik + ( $pl[3] * $count_add);  $out.= "add:" .$add_minik . " = (" . $pl[3] . " *" . $count_add.")<br>";   $out.= "add:" .$ost_minik . " = (". $pl[3] . " *" . $count_left.")<br>".$pl[2]."<br>";    }
