...
function calc_ost($left_card_count, $left_nominal ,$add_card_count,$add_nominal,$data_in,$shop_name,$id_sql){
        ...
        if ($left_card_summ != 99 ) {
                ...
                if ($left_card_summ > 0 ) { $array_pay[$shop_name][$data_in]["descr"] .= "left card summ: ".$left_card_summ ." = ". $left_nominal . " * " . $left_card_count . "<a href=# onclick='edit_sql(".$id_sql.");'>edit</a><button type='button' class='btn btn-default' data-dismiss='modal'>Close</button>\r\n";  }
