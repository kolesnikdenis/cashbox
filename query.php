        ...
        if($eierr=="no"){
                ...
                while ($pl=mysql_fetch_array($res)){
                  ...
                  //foreach ($global_summ as $key1 => &$value1 ){
                    ...
                    $out.="\$global_summ: ".$global_summ." key1: ".$key1. " $value1: ".$value1. " \$global_summ[name_magazine]". $global_summ[$name_magazine].  " - ".$pl[data_time]." \$count_add ".$count_add."\$count_left ".$count_left."<br>";
                  //}
